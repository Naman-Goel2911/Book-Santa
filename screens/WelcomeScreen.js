...
import {View, Text, Image, TextInput, TouchableOpacity, StyleSheet, Modal, ScrollView, KeyboardAvoidingView} from 'react-native';
...
const styles = StyleSheet.create({
    ...
    registerButtonText:{ color:'#ff5722', fontSize:15, fontWeight:'bold' }, cancelButton:{ width:200, height:30, justifyContent:'center', alignItems:'center', marginTop:5, }
